...
from bucket_iterator_bert import BucketIterator
from sklearn import metrics
from data_utils_bert import ABSADatesetReader
from models import LSTM, ASCNN, ASGCN, SenticGCN, ATTSenticGCN, SDGCN, AFFGCN, SenticGCN_BERT
...
class Instructor:
    def __init__(self, opt):
        ...
        if 'bert' in opt.model_name:
            absa_dataset = ABSADatesetReader(dataset=opt.dataset, embed_dim=opt.embed_dim, model='bert', pretrained_bert_name=opt.pretrained_bert_name)
        else:
...
if __name__ == '__main__':
    ...
    input_colses = {
        ...
        'senticgcn_bert': ['text_bert_indices', 'text_indices', 'aspect_indices', 'bert_segments_ids', 'left_indices', 'sdat_graph'],
